			...
			<nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 lg:rounded-lg dark:bg-gray-800 mx-auto lg:w-11/12 relative">
				<div className="flex flex-wrap justify-between items-center">
					...
					<div className="flex items-center">
						<Link href="/register">
							<a>
								<button type="button" onClick={()=>{toggleOpen(false)}} className="text-white bg-blue-700 hover:bg-blue-800 transition-colors focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 lg:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
									Register Today
								</button>
							</a>
						</Link>
